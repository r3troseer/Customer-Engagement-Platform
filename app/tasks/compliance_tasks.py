...
async def check_certification_expiry() -> None:
    ...
    #     critical_threshold = today + timedelta(days=settings.CERT_EXPIRY_CRITICAL_DAYS)
    #
    ...
    #     await db.commit()
    logger.info("check_certification_expiry triggered (not yet implemented)")
